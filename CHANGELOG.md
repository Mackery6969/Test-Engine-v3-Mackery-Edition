...
- Fixed a bug where characters would sometimes use the wrong scale value (thanks
  PurSnake!)
...
- Story mode scores not properly resetting, leading to VERY inflated highscores
